...
export class CheckoutPage {
    ...
    constructor(page: Page) {
        ...
        this.radioGuest = this.page.locator('input[value="guest"]');
        this.btnContinue = this.page.locator('#button-account');
        ...
        this.txtAddress2 = this.page.locator('#input-payment-address-2');
        this.txtCity = this.page.locator('#input-payment-city');
        this.txtPin = this.page.locator('#input-payment-postcode');
        this.drpCountry = this.page.locator('#input-payment-country');
        this.drpState = this.page.locator('#input-payment-zone');
        this.btnContinueBillingAddress = this.page.locator('#button-payment-address');
        this.btnContinueDeliveryAddress = this.page.locator('#button-shipping-address');
        this.txtDeliveryMethod = this.page.locator('textarea[name="comment"]');
        this.btnContinueShippingAddress = this.page.locator('#button-shipping-method');
        this.chkboxTerms = this.page.locator('input[name="agree"]');
        this.btnContinuePaymentMethod = this.page.locator('#button-payment-method');
        this.lblTotalPrice = this.page.locator('strong:has-text("Total:") + td');
        this.btnConfOrder = this.page.locator('#button-confirm');
        this.lblOrderConMsg = this.page.locator('#content h1');
    }
